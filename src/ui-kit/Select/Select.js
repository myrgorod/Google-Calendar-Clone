...
export default function UnstyledSelectControlled({
  ...
  return (
    <div>
      <Select
        value={valueRepeat}
        onChange={(_, newValue) => setValueRepeat(newValue)}
      >
        <Option value={10}>Does not repeat</Option>
        <Option value={20}>Daily</Option>
        <Option value={30}>Weekly on Thursday</Option>
        <Option value={40}>Monthly</Option>
        <Option value={50}>Annually</Option>
      </Select>
    </div>
  );
}
